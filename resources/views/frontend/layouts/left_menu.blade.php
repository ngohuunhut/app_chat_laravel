<div class="flex flex-col items-center py-4 flex-shrink-0 w-20 bg-indigo-800 rounded-3xl">
    ...
    {{-- End Nav Left - Icon Message --}}
    {{-- Nav Left - Component function --}}
    ...
    {{-- End Nav Left - Component function --}}
    {{-- Nav Left - Button dark mode --}}
